...
{{--    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('soft_ui/assets/img/apple-icon.png') }}">--}}
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('soft_ui/assets/css/soft-ui-dashboard.css?v=1.1.0') }}" rel="stylesheet" />
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('frontend.index') }}">
            <img src="{{ asset(config('view.logo.gray')) }}" class="navbar-brand-img h-100" alt="Arik Air Logo">
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url('{{ asset('soft_ui/assets/img/curved-images/white-curved.jpg') }}"></div>
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript: void(0);" onclick="history.back()"><i class="fas fa-arrow-left-long"></i> Back</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a href="{{ route('frontend.index') }}">Home</a></li>
                </ol>
                <h6 class="font-weight-bolder mb-0">@yield('title')</h6>
            </nav>
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <ul class="navbar-nav  justify-content-end">
                    <!-- Online builder button was here -->
...
{{--                                        <div class="my-auto">--}}
{{--                                            <img src="{{ asset('soft_ui/assets/img/team-2.jpg') }}" class="avatar avatar-sm  me-3 ">--}}
{{--                                        </div>--}}
...
{{--                                    <div class="d-flex py-1">--}}
{{--                                        <div class="my-auto">--}}
{{--                                            <img src="{{ asset('soft_ui/assets/img/small-logos/logo-spotify.svg) }}" class="avatar avatar-sm bg-gradient-dark  me-3 ">--}}
{{--                                        </div>--}}
{{--                                        <div class="d-flex flex-column justify-content-center">--}}
{{--                                            <h6 class="text-sm font-weight-normal mb-1">--}}
...
<!--   Core JS Files   -->
<script src="{{ asset('soft_ui/assets/js/core/popper.min.js') }}"></script>
<script src="{{ asset('soft_ui/assets/js/core/bootstrap.min.js') }}"></script>
<script src="{{ asset('soft_ui/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
<script src="{{ asset('soft_ui/assets/js/plugins/smooth-scrollbar.min.js') }}"></script>
<script>
...
<script src="{{ asset('soft_ui/assets/js/soft-ui-dashboard.min.js?v=1.1.0') }}"></script>
