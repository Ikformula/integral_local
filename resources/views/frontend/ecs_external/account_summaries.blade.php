...
@section('content')
    <div class="container-fluid">
        @if($logged_in_user->can('manage ecs client balances'))
            <div class="row mb-3">
                <div class="col-12">
                    <a href="{{ route('frontend.ecs_client_account_summaries.create') }}?client_id=@isset($client){{ $client->id }}@endisset" class="btn btn-primary">Add New Client Account Summary</a>
                </div>
            </div>
        @endif
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Account Summary @isset($client) - {{ $client->name_and_balance }} @endisset</h3>
                    </div>
                    <div class="card-body">
