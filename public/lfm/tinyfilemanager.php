...
//Application Title
define('APP_TITLE', 'Lawyers File Manager');
define('LARAVEL_URL', 'http://localhost/arik_web_portals/public/');
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        // Logged
    } elseif (isset($_GET['email'], $_GET['otp'])){
        // cURL to verify OTP
        $postParameter = array(
            'email' => $_POST['fm_usr'],
            'otp' => $_POST['fm_pwd']
        ...
        $curlHandle = curl_init(LARAVEL_URL.'api/verify-tfm-otp');
