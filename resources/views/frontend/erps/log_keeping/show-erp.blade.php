        ...
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="message_from" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="message_to">Message To:</label>
                                        <input type="text" class="form-control" id="message_to" required>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <form action="{{ route('frontend.log_keeping.delete.erp', $erp) }}" method="POST" onsubmit="return confirm('Deleting this will also delete all the logs under it. Continue?')">
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-danger btn-block">Delete This ERP</button>
                        </form>
                    </div>
                </div>
            </div>
