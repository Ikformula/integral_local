...
@section('title', 'Add New Legal Document')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add New {{ ucfirst($process_type) }} Processes Legal Document for {{ $case->firm }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('frontend.legal_team_documents.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
