            ...
            <div class="col-12">
                <div class="card my-2">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Filter by Business area and Year</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-4">
                                    <div class="form-group mb-0">
                                        <select class="form-control" name="week_range_id">
                                            @php $selected_year = isset($_GET['year']) ? $_GET['year'] : now()->year; @endphp
                                            @for($year = now()->year; $year >= 2024; $now--)
                                                <option {{ $selected_year == $year ? 'selected' : '' }}>{{ $year }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
