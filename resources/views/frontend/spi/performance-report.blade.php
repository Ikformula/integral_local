...
{{--    <link rel="stylesheet" href="{{ asset('adminlte3.2/css/adminlte.min.css') }}">--}}
    ...
    <style>
        ...
        @media print {
            ...
            table, tr, td, th, p, div, h1, h2, h3, h4, h5, h6 {
...
<img src="{{ asset('img/Arik_Air-Logo.wine.png') }}" class="img-fluid w-100">
                ...
                <hr style="border-width: 5px" class="border-5 border-secondary">
                ...
                <hr style="border-width: 5px" class="border-5 border-secondary mb-5">

                <hr style="border-width: 5px" class="border-5 border-secondary mt-5">
...
<h5>2.1 Annual Safety Implementation Plan</h5>
                ...
                <p>All safety and security indicators and targets are updated and revised overtime at the
                    direction of the Safety Department.</p><p>
                    ...
                    <div class="row mt-5">
                        <div class="col">
                                    <table class="table table-bordered table-hover table-stripped">
                                        <thead class="">
                                        <tr>
                                            <th colspan="7"><h2 style="color: {{ $sector_header_colours[$loop->index] }}">{{ $sector->sector_name }}</h2></th>
                                        </tr>
                                        <tr>
                                            <th>OBJECTIVES</th>
                                            <th>INDICATORS</th>
...
{{--                                                            <em>({{ $metric->unit }})</em>--}}
                                                        ...
                                                        @foreach(['Q1', 'Q2', 'Q3', 'Q4'] as $quarter)
                                                            ...
                                                            @endphp
                                                            <td class="" style="background-color: {{ empty($performance) || is_null($performance->colour_flag) ? '#f8d7da;' : $colour_codes[$performance->colour_flag] }}">
                                                                @if($performance)
                                                                    {{ $performance->amount }}
                                                                @else
                                                                    N/A
