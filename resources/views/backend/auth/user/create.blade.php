            ...
            <div class="card-body">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            {{ html()->label('Tour operator zone Name')->class('col-md-2 form-control-label')->for('tour_operator_zone_name') }}

                            <div class="col-md-10">
                                {{ html()->text('tour_operator_zone_name')
                                    ->class('form-control')
                                    ->placeholder('Tour operator zone Name')
                                     }}
                            </div><!--col-->
                        </div>

                        <div class="form-group row">
                            {{ html()->label('Tour operator zone Location')->class('col-md-2 form-control-label')->for('tour_operator_zone_location') }}
                            <div class="col-md-10">
                                {{ html()->text('tour_operator_zone_location')
                                    ->class('form-control')
                                    ->placeholder('Tour operator zone Location')
                                     }}
                            </div><!--col-->
                        </div>

                        <div class="form-group row">
                            {{ html()->label('Tour operator phone number')->class('col-md-2 form-control-label')->for('phone_number') }}
                            <div class="col-md-10">
                                {{ html()->text('phone_number')
                                    ->class('form-control')
                                    ->placeholder('Tour operator phone number')
                                     }}
                            </div><!--col-->
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th class="col-md-8">@lang('labels.backend.access.users.table.roles')</th>
                                            <th class="col-md-4">@lang('labels.backend.access.users.table.permissions')</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
