...
@if (config('services.google.active'))
    <a href='{{ route('frontend.auth.social.login', 'google') }}' class='btn btn-block bg-navy mt-4'><i class='fab fa-google'></i> @lang('labels.frontend.auth.login_with', ['social_media' => 'Your Arik ID'])</a>
@endif
