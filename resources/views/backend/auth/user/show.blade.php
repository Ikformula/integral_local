        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#staff_member" role="tab" aria-controls="overview" aria-expanded="true"><i class="fas fa-user"></i> Staff Member Info</a>
                    </li>
                        @endif
                </ul>
                ...
                <div class="tab-content">
                    ...
                    @if($user->staff_member)
                    <div class="tab-pane" id="staff_member" role="tabpanel" aria-expanded="false">
                        @include('backend.auth.user.show.tabs.staff_member')
                    </div><!--tab-->
                    @endif
                </div><!--tab-content-->
            </div><!--col-->
