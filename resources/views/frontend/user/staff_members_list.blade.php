                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href="{{ route('frontend.user.profile.editIDcard') }}?staff_ara_id={{ $staff_member->staff_ara_id }}&section=edit-manager">Edit Manager</a>
                                                        <a class="dropdown-item" href="{{ route('frontend.it_assets.staff.it.assets') }}?staff_ara_id={{ $staff_member->staff_ara_id }}">IT Assets</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
